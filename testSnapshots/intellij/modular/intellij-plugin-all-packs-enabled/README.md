...
│       └── resources/      plugin.all.packs.enabled.backend.xml
├── frontend/               Frontend module – UI and presentation
│   ├── build.gradle.kts
│   └── src/main/
│       ├── kotlin/         Kotlin production sources
│       └── resources/      plugin.all.packs.enabled.frontend.xml
├── shared/                 Shared module – cross-boundary contracts
│   ├── build.gradle.kts
│   └── src/main/
│       ├── kotlin/         Kotlin production sources
│       └── resources/      plugin.all.packs.enabled.shared.xml
├── gradle/
...
- `plugin.all.packs.enabled.backend.xml` – registers backend extensions and services
- `plugin.all.packs.enabled.frontend.xml` – registers frontend extensions and tool windows
- `plugin.all.packs.enabled.shared.xml` – registers shared extensions and interfaces
