...
- `intellij.plugin.qodana.github.backend.xml` – registers backend extensions and services
- `intellij.plugin.qodana.github.frontend.xml` – registers frontend extensions and tool windows
- `intellij.plugin.qodana.github.shared.xml` – registers shared extensions and interfaces
