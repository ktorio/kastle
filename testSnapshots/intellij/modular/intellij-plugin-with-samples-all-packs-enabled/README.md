...
│       └── resources/      plugin.with.samples.all.packs.enabled.backend.xml
├── frontend/               Frontend module – UI and presentation
│   ├── build.gradle.kts
│   └── src/main/
│       ├── kotlin/         Kotlin production sources
│       └── resources/      plugin.with.samples.all.packs.enabled.frontend.xml
├── shared/                 Shared module – cross-boundary contracts
│   ├── build.gradle.kts
│   └── src/main/
│       ├── kotlin/         Kotlin production sources
│       └── resources/      plugin.with.samples.all.packs.enabled.shared.xml
├── gradle/
...
- `plugin.with.samples.all.packs.enabled.backend.xml` – registers backend extensions and services
- `plugin.with.samples.all.packs.enabled.frontend.xml` – registers frontend extensions and tool windows
- `plugin.with.samples.all.packs.enabled.shared.xml` – registers shared extensions and interfaces
