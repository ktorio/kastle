...
- `plugin.backend.xml` – registers backend extensions and services
- `plugin.frontend.xml` – registers frontend extensions and tool windows
- `plugin.shared.xml` – registers shared extensions and interfaces
